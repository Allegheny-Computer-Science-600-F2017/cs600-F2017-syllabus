...
\begin{itemize}
  ...
  \item {\bf Written Proposal}: This document must be submitted, through the
    appropriate GitHub repository, to your first and second reader. Subject to
    multiple rounds of extensive revision, this document must be formatted
    according to the Department's thesis proposal style requirements and
  ...
  \item {\bf Proposal Defense}: This event is scheduled in consultation with
    ...
    has been formally approved, in writing, by their first reader; evidence of
    this approval must be submitted to Pauline Lanzine when scheduling the
    defense.
  ...
  \item {\bf Thesis Chapters}: Any two chapters of your final senior thesis must
    ...
    formatted in the department's thesis style; please note that this style is
    available from the course web site and it is different from the proposal's
    style.
